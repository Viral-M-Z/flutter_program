...
import 'package:flutter_program/common_utils/local_storage.dart';
import 'package:flutter_program/src/common_controller/common_controller.dart';
    ...
    return Sizer(
      builder: (BuildContext context, Orientation orientation, DeviceType deviceType) {
        return GetMaterialApp(
          ...
          // home: const MyHomePage(title: 'Flutter Practical'),
          ...
          getPages: [
            ...
            GetPage(name: ContactInfoScreen.route, page: () => ContactInfoScreen()),

            // GetPage(name: RouteNavigator.dashboard, page: () => DashboardScreen()),
...
Future<void> initServices() async {
  localStorage = await Get.putAsync(() => LocalStorage().init());
}
